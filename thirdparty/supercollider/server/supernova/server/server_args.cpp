...
#else  // NANOSYNTH_EMBEDDED

// When building as an embedded library, the argc/argv constructor is not
// available. Use initialize_embedded() + direct field assignment instead.
namespace nova {

server_arguments::server_arguments(int, char*[]) {
    // Stub -- never called in embedded mode
}

} /* namespace nova */

#endif  // NANOSYNTH_EMBEDDED
