if(NOT READLINE_INCLUDE_DIR OR NOT READLINE_LIBRARY)
    if(APPLE)
        ...
        find_path(READLINE_INCLUDE_DIR 
            ...
            HINTS "${PROJECT_SOURCE_DIR}/../${CMAKE_LIBRARY_ARCHITECTURE}/readline/include" # vcpkg
        ...
        find_library(READLINE_LIBRARY 
            NAMES readline
            HINTS "${PROJECT_SOURCE_DIR}/../${CMAKE_LIBRARY_ARCHITECTURE}/readline/lib"
    ...
    elseif(WIN32)
        find_path(READLINE_INCLUDE_DIR
            NAMES readline/readline.h
            HINTS "${PROJECT_SOURCE_DIR}/../${CMAKE_LIBRARY_ARCHITECTURE}/readline/include"
        ...
        find_library(READLINE_LIBRARY
            ...
            HINTS "${PROJECT_SOURCE_DIR}/../${CMAKE_LIBRARY_ARCHITECTURE}/readline/lib"
                "${PROJECT_SOURCE_DIR}/../${CMAKE_LIBRARY_ARCHITECTURE}/readline/bin"
        ...
        find_path(READLINE_LIBRARY_DIR
            ...
            HINTS "${PROJECT_SOURCE_DIR}/../${CMAKE_LIBRARY_ARCHITECTURE}/readline/bin"
                "$ENV{ProgramW6432}/GnuWin32/bin"
                "$ENV{ProgramFiles}/GnuWin32/bin"
            PATH_SUFFIXES "bin"
        )
